...
<article class="col s3 navbar">
    <ul>
        <li><a href="${contextPath}/nutritionist/edit.do?edit=personal">Edit Personal Data</a> </li>
        <li><a href="${contextPath}/nutritionist/edit.do?edit=curriculum">Edit Curriculum</a> </li>
    </ul>
</article>
<article class="col s8 <jstl:if test="${edit  != 'personal'}" > hidden</jstl:if>" style="margin-left:5%">
    <form:form action="nutritionist/edit.do" modelAttribute="actor" method="POST">
        <form:hidden path="id" />
        <h2>Personal data</h2>
       ...
       <div class="form-group-1 socialIdentity">
            <jstl:forEach var="si" items="socialIdentities" varStatus="loop">
        ...
        <button class="button cancel_button"><spring:message code="cancel" /></button>
    </form:form>
    </article>
